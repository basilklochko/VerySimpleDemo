...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});class WsService{constructor(e){this.ws=null,this.initiator=e}init(e){this.ws=new WebSocket(e)}send(e){this.ws.send(e)}listen(e){const t=this;this.ws.onmessage=function(i){t.initiator.initialLoad=!0,e(i)}}bindElements(){this.initiator.bindElements(this.caller)}}exports.WsService=WsService;class HttpService{constructor(e){this.initiator=e}delete(e){return new Promise((t,i)=>{let s=new XMLHttpRequest;s.onload=(()=>{t(s.response),this.initiator.initialLoad=!0,setTimeout(()=>this.initiator.bindElements(this.caller),100)}),s.onerror=(()=>i(s.statusText)),s.open("DELETE",e,!0),s.send(null)})}postJson(e,t){return new Promise((i,s)=>{let n=new XMLHttpRequest;n.onload=(()=>{i(n.response),this.initiator.initialLoad=!0,setTimeout(()=>this.initiator.bindElements(this.caller),100)}),n.onerror=(()=>s(n.statusText)),n.open("POST",e,!0),n.setRequestHeader("Content-Type","application/json; charset=utf-8"),n.send(JSON.stringify(t))})}putJson(e,t){return new Promise((i,s)=>{let n=new XMLHttpRequest;n.onload=(()=>{i(n.response),this.initiator.initialLoad=!0,setTimeout(()=>this.initiator.bindElements(this.caller),100)}),n.onerror=(()=>s(n.statusText)),n.open("PUT",e,!0),n.setRequestHeader("Content-Type","application/json; charset=utf-8"),n.send(JSON.stringify(t))})}getJson(e,t=null){return new Promise((t,i)=>{let s=new XMLHttpRequest;s.onload=(()=>{t(s.response),this.initiator.initialLoad=!0,setTimeout(()=>this.initiator.bindElements(this.caller),100)}),s.onerror=(()=>i(s.statusText)),s.open("GET",e),s.responseType="json",s.send()})}getText(e){return new Promise((t,i)=>{let s=new XMLHttpRequest;s.onload=(()=>t(s.response)),s.onerror=(()=>i(s.statusText)),s.open("GET",e),s.responseType="text",s.send()})}}exports.HttpService=HttpService;class ComponentService{constructor(e){this.initiator=e}renderPartial(e,t){return new Promise((i,s)=>{this.getPartial(e).then(e=>{this.initiator.renderPartial(e,t),i(!0)})})}renderText(e,t){this.initiator.renderPartial(e,t)}getPartial(e){return new Promise((t,i)=>{let s=new XMLHttpRequest;s.onload=(()=>t(s.response)),s.onerror=(()=>i(s.statusText)),s.open("GET",e),s.responseType="document",s.send()})}}exports.ComponentService=ComponentService;
